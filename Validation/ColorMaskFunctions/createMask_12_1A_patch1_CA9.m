function [BW,maskedRGBImage] = createMask_12_1A_patch1_CA9(RGB)
...
shiftVec = [0.000000 17.569477 6.223993];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [-0.308234 -0.001665 0.000000 0.701924;
    0.140892 -0.000467 0.005573 -0.497468;
    0.367616 -0.001217 -0.002136 8.759394;
...
hPoints(1).data = [0.254320 -0.199683;
    0.358309 -0.026118;
    0.681578 -0.359636;
    0.609238 -0.492363];
