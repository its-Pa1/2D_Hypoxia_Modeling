function [BW,maskedRGBImage] = createMask_0720_CA9_2(RGB)
...
% Auto-generated by colorThresholder app on 07-Dec-2022
%------------------------------------------------------
...
tMat = [-0.300296 -2.682210 0.000000 0.579359;
    -0.077880 0.021709 0.944046 -0.480902;
    1.698057 -0.473344 0.043298 8.232380;
...
hPoints(1).data = [0.002799 -0.593086;
    0.289213 -0.416084;
    0.472071 -0.473423;
    0.480467 -0.904708;
    0.172595 -1.006920;
