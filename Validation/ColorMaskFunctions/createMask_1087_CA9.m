function [BW,maskedRGBImage] = createMask_1087_CA9(RGB)
...
shiftVec = [0.004531 -0.000040 0.936382];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [1.377160 1.354452 -0.000000 -0.690367;
    -0.001609 0.003896 0.886786 -0.500280;
    -0.877616 2.125407 -0.001625 2.248384;
...
hPoints(1).data = [-0.417892 -0.492435;
    -0.084460 -0.536364;
    -0.016158 -0.652463;
    -0.063896 -0.796802;
    -0.423768 -0.781113;
