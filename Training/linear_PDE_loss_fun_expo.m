function loss = linear_PDE_loss_fun_expo(param, X, hypoxia_data, V, dx)
% LINEAR_PDE_LOSS_FUN_EXPO computes the loss function for exponential form of hypoxia equation.
...
hypoxia_calculated = gamma * exp(-k1 * H_O);

% Set the calculated hypoxia zero beyond the lower and upper threshold
